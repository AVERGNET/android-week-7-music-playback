...
public class MusicDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SongItem staringSong = getIntent().getParcelableExtra(MusicPlayerService.EXTRA_SONG);
        ...
        musicControls.updateViewMetadata(staringSong);
...
//        });
    ...
    private void registerBroadcastReceiver() {
        ...
        broadcastManager.registerReceiver(controlsBroadcastReceiver, intentFilter);
    }
